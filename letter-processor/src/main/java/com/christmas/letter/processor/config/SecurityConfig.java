...
import com.christmas.letter.processor.util.KeyRoleConverter;
...
public class SecurityConfig {
    ...
    @Bean
    @Profile("prod")
    SecurityFilterChain defaultFilterChain(HttpSecurity httpSecurity, CorsConfigurationSource corsConfigurationSource) throws Exception {
        return getSecurityFilterChain(httpSecurity, true);
    }

    @Bean
    @Profile("!prod")
    SecurityFilterChain devFilterChain(HttpSecurity httpSecurity, CorsConfigurationSource corsConfigurationSource) throws Exception {
    ...
    private SecurityFilterChain getSecurityFilterChain(HttpSecurity httpSecurity, boolean isProd) throws Exception {
        ...
        jwtAuthenticationConverter.setJwtGrantedAuthoritiesConverter(new KeyRoleConverter());
